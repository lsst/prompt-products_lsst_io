...
6. The large catalog of overlapping linkages produced by HelioLinC3D is refined using "Method of Herget" orbit fitting (see https://www.projectpluto.com/herget.htm for details), producing a final set of non-overlapping, high-purity linkages that have sub-arcsecond astrometric residuals relative to the best-fit orbit -- and still meet the requirement of including tracklets from at least three distinct nights within a 14-day time span.
