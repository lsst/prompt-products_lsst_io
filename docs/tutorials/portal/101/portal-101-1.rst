...
Click on the tab labeled "Alert Viewer". The Alert Viewer requires a known Alert ID, which matches the `DiaSourceId` of the triggering `DiaSource`. For the purpose of this tutorial, use the Alert ID 170059317401616524, selected from the `ALeRCE broker <https://lsst.alerce.online/object/170059286935240883?survey=lsst>`_.
